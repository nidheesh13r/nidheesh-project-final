...
- Name: smoke-tests.spec.ts >> Luxe Travel Smoke Suite - 20 Cases >> TAHA-20 Booking page shows price per night
- Location: tests\smoke-tests.spec.ts:121:7
...
Call log:
  ...
  - waiting for getByText(/5,000|5000/)
