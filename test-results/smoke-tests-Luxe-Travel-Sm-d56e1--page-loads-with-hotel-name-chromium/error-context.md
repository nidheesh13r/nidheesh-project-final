...
- Name: smoke-tests.spec.ts >> Luxe Travel Smoke Suite - 20 Cases >> TAHA-11 Booking page loads with hotel name
- Location: tests\smoke-tests.spec.ts:66:7
...
Locator: locator('input[readonly]').first()
Expected: visible
Timeout: 5000ms
