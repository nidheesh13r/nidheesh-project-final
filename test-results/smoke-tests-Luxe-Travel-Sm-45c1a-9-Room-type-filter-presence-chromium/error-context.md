...
- Name: smoke-tests.spec.ts >> Luxe Travel Smoke Suite - 20 Cases >> TAHA-9 Room type filter presence
- Location: tests\smoke-tests.spec.ts:55:7
...
Locator: locator('.search-cell').nth(3)
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('.search-cell').nth(3)
