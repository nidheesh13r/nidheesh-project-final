...
- Name: smoke-tests.spec.ts >> Luxe Travel Smoke Suite - 20 Cases >> TAHA-14 Check-out date input exists
- Location: tests\smoke-tests.spec.ts:81:7
...
Locator: locator('input[type="date"]').nth(1)
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('input[type="date"]').nth(1)
