...
- Name: smoke-tests.spec.ts >> Luxe Travel Smoke Suite - 20 Cases >> TAHA-8 City options are populated
- Location: tests\smoke-tests.spec.ts:48:7
...
Call log:
  - waiting for locator('.hotel-city-trigger').first()
