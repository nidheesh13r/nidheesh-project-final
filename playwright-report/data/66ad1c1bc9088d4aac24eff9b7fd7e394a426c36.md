...
- Name: smoke-tests.spec.ts >> Luxe Travel Smoke Suite - 20 Cases >> TAHA-18 Government ID format validation
- Location: tests\smoke-tests.spec.ts:106:7
...
Call log:
  - waiting for locator('input[placeholder*="Passport"]')
