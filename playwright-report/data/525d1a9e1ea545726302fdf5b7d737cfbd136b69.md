...
- Name: smoke-tests.spec.ts >> Luxe Travel Smoke Suite - 20 Cases >> TAHA-19 Guest count defaults to 2
- Location: tests\smoke-tests.spec.ts:115:7
...
Locator: locator('input[type="number"]').nth(1)
Expected: "2"
Timeout: 5000ms
